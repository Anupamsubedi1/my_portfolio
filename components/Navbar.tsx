              ...
              {navItems.map((item, index) => (
                <motion.button
                  ...
                  onClick={(e) => {
                    ...
                    console.log('Clicked:', item.name, 'Target ID:', targetId, 'Element found:', !!target);
                    if (target) {
                      setIsOpen(false);
                      setTimeout(() => {
                        const yOffset = -80;
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl font-medium transition-all duration-300 text-sm sm:text-base cursor-pointer ${
                    activeSection === item.href.substring(1)
